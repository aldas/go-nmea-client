...
func TestDecoder_Decode(t *testing.T) {
	...
	var testCases = []struct {
	...
	}{
		{
			...
			expect: nmea.Message{
				...
				Fields: nmea.FieldValues{
					{ID: "sid", Value: uint64(0)}, // 0x0
					{ID: "pitch", Value: -0.0905}, // 0x77fc => -905 * 0.0001 = -0.0905
					{ID: "roll", Value: -0.1556},  // 0xecf9 => -1556 * 0.0001 = -0.1556
				},
			},
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: nmea.FieldValues{
					{ID: "manufacturerCode", Value: uint64(1855)},
					{ID: "reserved", Value: []byte{3}},
					{ID: "industryCode", Value: uint64(4)},
				},
			},
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: nmea.FieldValues{
					{ID: "sid", Value: uint64(205)},
					{ID: "instance", Value: uint64(1)},
					{ID: "dcType", Value: uint64(0)},
					{ID: "stateOfCharge", Value: uint64(100)},
					{ID: "timeRemaining", Value: 184*time.Hour + 14*time.Minute},
					{ID: "rippleVoltage", Value: 1.69},
					{ID: "remainingCapacity", Value: uint64(256)},
				},
			},
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: nmea.FieldValues{
					{ID: "manufacturerCode", Value: uint64(461)},
					{ID: "data", Value: []byte{0x0, 0x64}},
				},
			},
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: nmea.FieldValues{
					{ID: "messageId", Value: uint64(24)},
					{ID: "repeatIndicator", Value: uint64(0)},
					{ID: "userId", Value: uint64(244810069)},            // MMSI => 0x5581970E
					{ID: "name", Value: "WITTE RAAF"},                   // STRING_FIX
					{ID: "aisTransceiverInformation", Value: uint64(1)}, // 0xe1, 0xff
				},
			},
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: []nmea.FieldValue{
					{ID: "installationDescription1", Value: ""},
					{ID: "installationDescription2", Value: ""},
					{ID: "manufacturerInformation", Value: "Airmar 1-603-673-9570 www.airmar.com"}, // STRING_LAU
				},
			},
			expectError: "",
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: []nmea.FieldValue{
					{ID: "manufacturerCode", Value: uint64(419)},
					{ID: "industryCode", Value: uint64(4)},
					{ID: "messageId", Value: uint64(11)},
					{ID: "a", Value: uint64(128)},
					{ID: "amFm", Value: uint64(1)},
					{ID: "b", Value: uint64(2)},
					{ID: "frequency", Value: uint64(88000000)},
					{ID: "c", Value: uint64(199)},
					{ID: "track", Value: "AVROTROS"},
				},
			},
			expectError: "",
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: []nmea.FieldValue{
					{ID: "uniqueNumber", Value: uint64(165550)},
					{ID: "manufacturerCode", Value: uint64(273)},
					{ID: "deviceInstanceLower", Value: uint64(0)},
					{ID: "deviceInstanceUpper", Value: uint64(0)},
					{ID: "deviceFunction", Value: uint64(130)},
					{ID: "spare", Value: []byte{0x0}},
					{ID: "deviceClass", Value: uint64(25)},
					{ID: "systemInstance", Value: uint64(0)},
					{ID: "industryGroup", Value: uint64(4)},
				},
			},
			expectError: "",
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: []nmea.FieldValue{
					{ID: "uniqueNumber", Value: uint64(175513)},
					{ID: "manufacturerCode", Value: nmea.EnumValue{Value: 273, Code: "Actisense"}},
					{ID: "deviceInstanceLower", Value: uint64(0)},
					{ID: "deviceInstanceUpper", Value: uint64(0)},
					{ID: "deviceFunction", Value: nmea.EnumValue{Value: 160, Code: "Engine Gateway"}}, // indirect lookup
					{ID: "deviceClass", Value: nmea.EnumValue{Value: 50, Code: "Propulsion"}},
					{ID: "systemInstance", Value: uint64(0)},
					{ID: "industryGroup", Value: nmea.EnumValue{Value: 4, Code: "Marine"}},
				},
			},
			expectError: "",
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: []nmea.FieldValue{
					{ID: "instance", Value: uint64(0)},
					{ID: "oilPressure", Value: float64(4000)},
					{ID: "temperature", Value: float64(291.15)},
					{ID: "alternatorPotential", Value: float64(8.55)},
					{ID: "fuelRate", Value: float64(0)},
					{ID: "totalEngineHours", Value: 103*time.Hour + 36*time.Minute},
					{ID: "discreteStatus1", Value: uint64(32)}, // BITLOOKUP field
					{ID: "discreteStatus2", Value: uint64(0)},  // BITLOOKUP field
					{ID: "engineTorque", Value: int64(-1)},
				},
			},
			expectError: "",
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: []nmea.FieldValue{
					{ID: "instance", Value: nmea.EnumValue{Value: 0x0, Code: "Single Engine or Dual Engine Port"}},
					{ID: "oilPressure", Value: float64(4000)},
					{ID: "temperature", Value: float64(291.15)},
					{ID: "alternatorPotential", Value: float64(8.55)},
					{ID: "fuelRate", Value: float64(0)},
					{ID: "totalEngineHours", Value: 103*time.Hour + 36*time.Minute},
					{ID: "discreteStatus1", Value: []nmea.EnumValue{
						{Value: 5, Code: "Low System Voltage"},
					}}, // BITLOOKUP field
					{ID: "discreteStatus2", Value: []nmea.EnumValue{}}, // BITLOOKUP field
					{ID: "engineTorque", Value: int64(-1)},
				},
			},
			expectError: "",
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: []nmea.FieldValue{
					{ID: "dscFormat", Value: uint64(112)},
					{ID: "dscCategory", Value: uint64(112)},
					{ID: "dscMessageAddress", Value: uint64(5120009530)},
					{ID: "natureOfDistress", Value: uint64(110)},
					{ID: "subsequentCommunicationModeOr2ndTelecommand", Value: uint64(100)},
					{ID: "telephoneNumber", Value: ""},
					{ID: "proposedRxFrequencyChannel", Value: ""},
					{ID: "proposedTxFrequencyChannel", Value: ""},
					{ID: "latitudeOfVesselReported", Value: -41.101479999999995},
					{ID: "longitudeOfVesselReported", Value: 174.8676983},
					{ID: "timeOfPosition", Value: 2*time.Hour + 13*time.Minute},
					{ID: "dscEosSymbol", Value: uint64(127)},
					{ID: "expansionEnabled", Value: uint64(1)},
					{ID: "callingRxFrequencyChannel", Value: ""},
					{ID: "callingTxFrequencyChannel", Value: ""},
					{ID: "FIELDSET_1", Value: [][]nmea.FieldValue{
						{
							{ID: "dscExpansionFieldSymbol", Value: uint64(100)},
							{ID: "dscExpansionFieldData", Value: "08"},
						},
					}},
				},
			},
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: []nmea.FieldValue{
					...
					{ID: "date", Value: time.Date(2021, time.May, 14, 0, 0, 0, 0, time.UTC)},
					{ID: "time", Value: time.Duration(25600500000000)},
					{ID: "latitude", Value: 58.2161881666666},
					{ID: "longitude", Value: 22.39428733333333},
					{ID: "altitude", Value: 0.14},
					{ID: "gnssType", Value: uint64(2)},
					{ID: "method", Value: uint64(1)},
					{ID: "integrity", Value: uint64(0)},
					{ID: "numberOfSvs", Value: uint64(0)},
					{ID: "hdop", Value: 0.6},
					{ID: "pdop", Value: 0.9},
					{ID: "geoidalSeparation", Value: 22.2},
					{ID: "referenceStations", Value: uint64(0)},
				},
			},
		},
		{
			...
			expect: nmea.Message{
				...
				Fields: []nmea.FieldValue{
					{ID: "functionCode", Value: uint64(1)},
					{ID: "FIELDSET_1", Value: [][]nmea.FieldValue{
						{
							{ID: "pgn", Value: uint64(130820)},
							{ID: "pgn", Value: uint64(129809)},
						},
					}},
				},
			},
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			message_test.AssertRawMessage(t, tc.expect, result, 0.00000_00001)
			if tc.expectError != "" {
